...
ACLOCAL = ${SHELL} /root/src/library/libunwind/config/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
ARCH = X86_64
AUTOCONF = ${SHELL} /root/src/library/libunwind/config/missing autoconf
AUTOHEADER = ${SHELL} /root/src/library/libunwind/config/missing autoheader
AUTOMAKE = ${SHELL} /root/src/library/libunwind/config/missing automake-1.15
AWK = gawk
BACKTRACELIB = 
CC = gcc
CCAS = gcc
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /root/src/library/libunwind/config/missing makeinfo
MANIFEST_TOOL = :
...
VERSION = 1.70
abs_builddir = /root/src/library/libunwind
abs_srcdir = /root/src/library/libunwind
abs_top_builddir = /root/src/library/libunwind
abs_top_srcdir = /root/src/library/libunwind
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/src/library/libunwind/config/install-sh
